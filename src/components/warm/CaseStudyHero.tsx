  ...
  return (
    ...
    >
        ...
        <div className="warm-cs-hero__left">
          {(caseNumber || partnerName) && (
            ...
            >
              ...
              {caseNumber && partnerName && (
                <span style={{ color: "var(--warm-ink-mute, rgba(42,15,8,0.65))" }}>
                  {" "}
                  /{" "}
                </span>
              )}
      ...
      <style>{`
        ...
        .warm-cs-hero__left {
          padding: clamp(40px, 5vw, 80px) var(--warm-content-padding) clamp(28px, 4vw, 56px);
          display: flex;
          flex-direction: column;
        ...
        .warm-cs-hero--stacked .warm-cs-hero__right {
          padding: 0 var(--warm-content-padding) clamp(40px, 5vw, 80px);
        }
  ...
  return (
    <motion.figure
      ...
      style={{
        ...
        boxShadow: "var(--warm-shadow-lg, 0 16px 48px rgba(42,15,8,0.12))",
      }}
    >
      <Image
        src={image.src}
      ...
      >
        <motion.figure
          ...
          style={{
            ...
            border: "1px solid var(--warm-border, rgba(42,15,8,0.2))",
            boxShadow:
              "var(--warm-shadow-lg, 0 16px 48px rgba(42,15,8,0.12))",
        ...
        {secondary && (
          <motion.figure
            ...
            style={{
              ...
              border: "1px solid var(--warm-border, rgba(42,15,8,0.2))",
              boxShadow:
                "var(--warm-shadow-xl, 0 32px 80px rgba(42,15,8,0.16))",
              zIndex: 1,
            }}
          >
            <Image
