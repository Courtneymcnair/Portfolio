    ...
    <>
      ...
      <nav
        style={{
          ...
          padding: "clamp(10px, 2.2vw, 20px) var(--warm-content-padding)",
        ...
        {menuOpen ? (
          <div
            ...
            style={{
              ...
              gap: 4,
              padding: "16px var(--warm-content-padding) 28px",
              background: "rgba(255, 233, 214, 0.96)",
              backdropFilter: "blur(16px)",
              WebkitBackdropFilter: "blur(16px)",
              borderBottom: "1px solid var(--warm-hair-strong, rgba(42,15,8,0.32))",
            ...
            {links.map((link) => {
              ...
              return (
                ...
                >
                  ...
                  <span aria-hidden style={{ color: "var(--warm-ink-mute, rgba(42,15,8,0.65))", fontSize: 18 }}>
                    →
                  </span>
                </a>
              );
